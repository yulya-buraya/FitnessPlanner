...
export const MealPlanBlockItem = ({ setMealPlans, mealPlan }) => {
    ...
    return <div className="mealplan-item" >
        ...
        <div className="short-info-recipe-for-admin " onClick={() => openMealPlan()}>
            ...
            <br />
                ...
                <p className="value-count-meals"><span className="text-subtitle-meals">Количество приёмов пищи: </span>{mealPlan.meals.length}</p>
                </div>
        </div>
