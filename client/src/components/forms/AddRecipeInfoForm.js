                    ...
                    <div className="user-info-form">
                        ...
                        <div className="wrap-input100">
                                ...
                                <input className="input-info-forms" type="text" name="ingredients"
                                    placeholder="Введите количество ингредиентов" id="ingredients" value={ingredients}
                                    onChange={(e)=>{setCountIngredients(e.target.value)}} onFocus={setClassForIngredients}
                            ...
                            <div className="wrap-input100">
                                ...
                                <input className="input-info-forms" type="text" name="instructions"
                                    placeholder="Введите количество шагов в инструкции" id="instructions" value={instructions}
                                    onChange={(e)=>{setCountInstructions(e.target.value)}} onFocus={setClassForInstructions}
