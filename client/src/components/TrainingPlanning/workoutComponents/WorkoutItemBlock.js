...
export const WorkoutItemBlock = ({ workout, setWorkouts }) => {
    ...
    if (role == "user") {
        return (
            ...
            <div className="workout-item" onClick={() => openWorkout()}>
                ...
                <div className="short-info-workout">
                    ...
                    <p className="text-workout"><span className="text-subtitle-workout">Инвентарь: </span> {workout.inventory} </p>
                    <p className="text-workout"><span className="text-subtitle-workout">Тип: </span>{workout.purpose}</p>
                </div>
            </div>
        ...
        return <div className="workout-item-for-admin" onClick={() => openWorkout()}>
            <img className="workout-image-for-admin" src="/image/loseWeight.jpg" />
